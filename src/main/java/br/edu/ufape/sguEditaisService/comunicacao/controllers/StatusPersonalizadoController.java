...
//
//    @PostMapping
//    public ResponseEntity<StatusPersonalizadoResponse> criarStatus(@Valid @RequestBody StatusPersonalizadoRequest request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.criarStatusPersonalizado(request));
//    }
//
//    @GetMapping
//    public ResponseEntity<List<StatusPersonalizadoResponse>> listarTodos(
//            @RequestParam(required = false) TipoStatus tipoStatus) {
//
//        // Se a rota for /status-personalizado?tipoStatus=EDITAL, filtra. Senão, traz todos.
//        if (tipoStatus != null) {
//            return ResponseEntity.ok(fachada.listarStatusPorTipo(tipoStatus));
//        }
...
//        return ResponseEntity.ok(fachada.buscarStatusPersonalizado(id));
//    }
//
//    @PatchMapping("/{id}")
//    public ResponseEntity<StatusPersonalizadoResponse> editarStatus(@PathVariable Long id, @Valid @RequestBody StatusPersonalizadoRequest request) {
