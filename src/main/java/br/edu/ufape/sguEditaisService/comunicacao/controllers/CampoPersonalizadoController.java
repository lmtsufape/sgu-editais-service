...
//
//    @PatchMapping("/{id}")
//    public ResponseEntity<CampoPersonalizadoResponse> editarCampo(@PathVariable Long id, @Valid @RequestBody CampoPersonalizadoRequest request) {
//        return ResponseEntity.ok(fachada.editarCampo(id, request));
//    }
//
//    @DeleteMapping("/{id}")
//    public ResponseEntity<Void> deletarCampo(@PathVariable Long id) {
//        fachada.deletarCampo(id);
