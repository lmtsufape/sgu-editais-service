...
//
//    @PatchMapping("/{id}")
//    public ResponseEntity<EtapaResponse> editarEtapa(@PathVariable Long id, @Valid @RequestBody EtapaRequest request) {
//        return ResponseEntity.ok(fachada.editarEtapa(id, request));
//    }
//
//    @DeleteMapping("/{id}")
