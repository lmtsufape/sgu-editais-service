...
//
//    @PostMapping
//    public ResponseEntity<EditalResponse> criarEdital(@Valid @RequestBody EditalRequest request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.criarEdital(request));
//    }
//
//    @GetMapping
//    public ResponseEntity<List<EditalResponse>> listarTodos() {
//        return ResponseEntity.ok(fachada.listarEditais());
//    }
//
//    @GetMapping("/{id}")
//    public ResponseEntity<EditalResponse> buscarPorId(@PathVariable Long id) {
//        return ResponseEntity.ok(fachada.buscarEdital(id));
//    }
//
//    @DeleteMapping("/{id}")
...
//    public ResponseEntity<EditalResponse> adicionarEtapaAEditalExistente(
//            @PathVariable Long id,
//            @Valid @RequestBody EtapaEditalRequest request) {
//
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.adicionarEtapaAoEdital(id, request));
//    }
//}