...
//
//    @PostMapping
//    public ResponseEntity<TipoEditalResponse> criarModeloCompleto(@Valid @RequestBody TipoEditalRequest request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.criarTipoEditalCompleto(request));
//    }
//
//    @GetMapping
//    public ResponseEntity<List<TipoEditalResponse>> listarTodos() {
//        return ResponseEntity.ok(fachada.listarTiposEdital());
//    }
//
//    @GetMapping("/{id}")
//    public ResponseEntity<TipoEditalResponse> buscarPorId(@PathVariable Long id) {
//        return ResponseEntity.ok(fachada.buscarTipoEditalCompleto(id));
//    }
//
//    @DeleteMapping("/{id}")
...
//    }
//
//    // --- ROTAS DE SUB-RECURSOS (Adição dinâmica) ---
//
//    @PostMapping("/{id}/etapas")
//    public ResponseEntity<EtapaResponse> adicionarEtapa(@PathVariable Long id, @Valid @RequestBody EtapaRequest request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.adicionarEtapaAoModelo(id, request));
//    }
//
//    @PostMapping("/{id}/campos")
//    public ResponseEntity<CampoPersonalizadoResponse> adicionarCampo(@PathVariable Long id, @Valid @RequestBody CampoPersonalizadoRequest request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(fachada.adicionarCampoAoModelo(id, request));
//    }
//}